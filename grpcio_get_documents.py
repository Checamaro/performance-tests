...
get_tariff_document_response = documents_gateway_service.GetTariffDocument(get_tariff_document_request)
...
get_contract_document_response = documents_gateway_service.GetContractDocument(get_contract_document_request)
