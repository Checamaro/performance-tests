...
class OperationsGatewayGRPCClient(GRPCClient):
    ...
    def get_operation_api(self, request: GetOperationRequest) -> GetOperationResponse:
        ...
        :param request: gRPC-запрос с информацией об операции пользователя.
        :return: Ответ от сервиса с данными операции пользователя.
        """
    ...
    def get_operation_receipt_api(self, request: GetOperationReceiptRequest) -> GetOperationReceiptResponse:
        ...
        :param request: gRPC-запрос с получением чека по операции.
    ...
    def get_operations_api(self, request: GetOperationsRequest) -> GetOperationsResponse:
        ...
        :param request: gRPC-запрос с получением списка операций.
    ...
    def get_operations_summary_api(self, request: GetOperationsSummaryRequest) -> GetOperationsSummaryResponse:
        ...
        :param request: gRPC-запрос с получением статистики по операциям.
    ...
    def make_bill_payment_operation_api(self,
        ...
        :param request: gRPC-запрос для создания операции оплаты по счету.
    ...
    def make_cash_withdrawal_operation_api(self,
        ...
        :return: Ответ от сервиса с операцией снятия наличных.
        """
    ...
    def make_cash_withdrawal_operation(self, card_id: str,
                                       account_id: str) -> MakeCashWithdrawalOperationResponse:
